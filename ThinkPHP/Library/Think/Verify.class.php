...
class Verify {
    ...
    public function entry($id = '') {
        ...
        if($this->useZh){ // 中文验证码
            ...
            for ($i = 0; $i<$this->length; $i++) {
                ...
                imagettftext($this->_image, $this->fontSize, mt_rand(-10, 10), $codeNX, $this->fontSize*1.2, $this->_color, $this->fontttf, $code[$i]);
            }
        }
    ...
    private function _writeCurve() {
        ...
        $px1 = 0;  // 曲线横坐标起始位置
        $px2 = mt_rand($this->imageW/10, $this->imageW * 0.2);  // 曲线横坐标结束位置
