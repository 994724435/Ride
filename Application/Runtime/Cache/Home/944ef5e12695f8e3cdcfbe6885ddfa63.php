...
<div id="content">
	<div class="content">
		<div class="content-left-nav">
			<div class="left-nav">
				...
				<div class="left-content">
					<ul>
						<li class="active active01"><a href="/index.php/Home/Communicate/Lead_mailbox">领导信箱</a></li>
		...
		<div class="content-right">
			<div class="title">
				<a href="">首页</a> > <a href="">互动交流</a> > <a href="" class="on">领导信箱</a>
			</div>
			<div class="lead">
				<div class="write-letters">
					<form action="/index.php/Home/Communicate/Lead_mailbox" method="post">
					<!--<h4>我要写信</h4>-->
					<!--<div class="cmlt01">
