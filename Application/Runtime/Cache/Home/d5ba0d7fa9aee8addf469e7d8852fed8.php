	...
	<div class="content">
		...
		<div class="content-right">
			<div class="title title01">
				<a href="/index.php/Home/Index/index">首页</a> > <a href="" class="on">信件</a>
				<!--<a href="" class="last">more 》</a>-->
			</div>

			<ul class="inside-list">
			<table border="1" cellspacing="0" cellpadding="0" style="text-align: center;">
				<tr><th width="60px">姓 名</th><th width="150px">主 题</th><th width="390px">内 容</th><th width="50px">操作</th></tr>
			<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr style="height: 40px;"><td><?php echo ($val['ad_name']); ?></td><td><?php echo ($val['ad_theme']); ?></td><td><?php echo ($val['ad_content']); ?></td><td><a href="/index.php/Home/Index/header_delete/id/<?php echo ($val['ad_id']); ?>">删除</a></td></tr><?php endforeach; endif; ?>		
			</table>	
		   </ul>
