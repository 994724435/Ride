	...
	<div class="content">
			...
			<div class="left-nav">
				...
				<div class="left-content">
					<ul>
						...
						<li  class="active active01"><a href="/index.php/Home/Article/Tieqi">铁骑之声</a></li>
		...
		<div class="content-right">
			<div class="title title01">
				<a href="/index.php/Home/Index/index">首页</a> >  <a href="" class="on">铁骑之声</a>
				<!--<a href="" class="last">more 》</a>-->
			</div>

			<ul class="inside-list">
			<?php if(is_array($data)): foreach($data as $key=>$val): ?><li><a href="/index.php/Home/Article/tdetail/id/<?php echo ($val["tg_id"]); ?>">
					<span class="fl"><i>·</i><?php echo ($val["tg_theme"]); ?></span>
					<span class="fr"><?php echo ($val["tg_addtime"]); ?></span>
				</a></li><?php endforeach; endif; ?>	
		<div class="" style="margin:160px 0 0 230px;">
			<a href="/index.php/Home/Article/tougao"><button style="display: block;font-size:16px;color: whitesmoke;height: 30px;width:90px;background-color: orangered;">我要投稿</button></a>
        </div>			
			</ul>
