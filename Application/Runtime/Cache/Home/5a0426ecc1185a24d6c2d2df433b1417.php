...
<div id="content">
	<div class="content">
		...
		<div class="content-right">
			...
			<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr style="height: 40px;"><td><?php echo ($val['ad_name']); ?></td><td><?php echo ($val['ad_theme']); ?></td><td><?php echo ($val['ad_content']); ?></td><td><a href="/index.php/Home/Index/jiwei_delete/id/<?php echo ($val['ad_id']); ?>">删除</a></td></tr><?php endforeach; endif; ?>		
			</table>	
		   </ul>
