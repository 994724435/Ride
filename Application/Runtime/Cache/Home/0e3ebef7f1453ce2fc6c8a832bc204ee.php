	...
	<div class="content">
		...
		<div class="content-right">
			...
			<div class="right-content">
				...
				<dl>
			   <img src="<?php echo ($data["art_thumb"]); ?>" style="width:460px;margin: 0 auto;display:<?php if(!isset($data['art_thumb'])){echo 'none';} ?>"/>	<br />
			   <img src="<?php echo ($data["art_thumb1"]); ?>" style="width:460px;margin: 0 auto;display:<?php if(!isset($data['art_thumb1'])){echo 'none';} ?>"/><br />
			   <img src="<?php echo ($data["art_thumb2"]); ?>" style="width:460px;margin: 0 auto;display:<?php if(!isset($data['art_thumb2'])){echo 'none';} ?>"/>
				</dl>				
				<dl>
