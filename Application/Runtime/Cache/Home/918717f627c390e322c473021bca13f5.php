	...
	<div class="content">
			...
			<div class="left-nav">
				...
				<div class="left-content">
					<ul>
						...
						<li  class="active active01" class="last"><a href="/index.php/Home/Article/Download">下载中心</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="content-right">
			<div class="title title01">
				<a href="/index.php/Home/Index/index">首页</a> > <a href="" class="on">下载中心</a>
				<!--<a href="" class="last">more 》</a>-->
			</div>

			<ul class="inside-list">
			<?php if(is_array($data)): foreach($data as $key=>$val): ?><li><a href="<?php echo ($val['ban_url']); ?>">
					<span class="fl"><i>·</i><?php echo ($val['ban_name']); ?></span>
					<span class="fr"><?php echo ($val['ban_addtime']); ?></span>
