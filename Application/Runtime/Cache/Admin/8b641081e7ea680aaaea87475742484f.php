...
<!--文章编辑-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass" href="/Admin/Product/index">产品管理</a><a class="home_now">添加产品</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/Admin/Product/add');?>" method='post' enctype="multipart/form-data">
    <div class="article_edit_list">
      <div class="edit_title"><div class="col_left f">标题</div><div class="col_right f"><input type="text" name="title" class="title_text" value=""/></div><div class="clear"></div></div>
      <div class="clear"></div>
      <div class="choose_sort same_height">
        ...
        <div class="col_right f">
          ...
          <select class="sort f" name="scate" id="scate" style="margin-left:25px;">
            <option value="">未分类</option>
          </select> 
          <div class="f"><input type="text" class="newsort" style="width:120px;"><label class="newsorttext">新建分类</label></div>
          <div class="clear"></div>
        </div>
      </div>
      <div class="clear"></div>
        ...
        <div class="clear"></div>
        <div class="submit_person same_height"><div class="col_left f">商家名称</div><div class="col_right f"><input type="text" name="author" class="title_text" vallue="" /></div><div class="clear"></div></div>
        <div class="clear"></div>
        <div class="public same_height"><div class="col_left f">上架日期</div><div class="col_right f"><input type="text"  class="title_text" readonly="true" name="time" value="<?php echo (date("Y-m-d",$time)); ?>" /></div><div class="clear"></div></div>
        <div class="clear"></div>
        <div class="source same_height"><div class="col_left f">来源</div><div class="col_right f"><input type="text" class="title_text" name="source" value="" /></div><div class="clear"></div></div>
        <div class="clear"></div>
        <!-- 产品价格 -->
        <div class="public same_height"><div class="col_left f">销售价格</div><div class="col_right f"><input type="text" value="<?php echo ($pro["pro_general_price"]); ?>" name="general_price" class="sale_price"/><label class="price_lab">会员价格</label><input type="text" value="<?php echo ($pro["pro_member_price"]); ?>" name="member_price" class="sale_price"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 产品价格 -->
        <div class="public same_height"><div class="col_left f">产品排序</div><div class="col_right f"><input type="text" value="<?php echo ($pro["pro_general_price"]); ?>" name="general_price" class="sale_price"/></div><div class="clear"></div></div> <div class="clear"></div>
...
if(adm_power.indexOf('添加产品') === -1){
  ...
  $("#cate").change(function(){
    var pid=$(this).val();
    if(pid){
      $.post('/Admin/Product/cateAjax',{'pid':pid},function(data){
  ...
  $(".newsorttext").click(function(){
    ...
    var cid = $("#cate").val();
    $.post('/Admin/Product/sortAjax',{'sort':sort,'cid':cid},function(data){
        if(!cid){
