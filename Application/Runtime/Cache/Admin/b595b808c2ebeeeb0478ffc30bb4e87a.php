...
<div class="rightfix">
  ...
  <div style="width:1044px; margin-left:20px;">
    <div class="info">
      <div class="photo"></div>
      <div class="weltxt">
        <p class="p1">欢迎您<span><?php echo ($current_admin["admin_relname"]); ?></span>登录后台管理系统！</p>
        <?php if($current_admin['admin_level'] == 1): ?><p class="p2">您是超级管理员</p>
        <?php else: ?><p class="p2">您是普通管理员</p><?php endif; ?>
      </div>
    </div>
    <div class="change">
      <div class="youcan">您可以：</div>
      <?php if($current_admin['admin_level'] == 1): ?><div class="circle1  show_block changePassword_block" id="ch_pa2">修改账号密码</div><div class="circle2 show_block addAdmin_block" id="addadmin2">添加管理员</div><div class="circle3 show_block changePermissions_block" id="setpower2">设置权限</div><div class="circle4 show_block friendShip2_notice_block" id="logout2">退出系统</div>
      <?php else: ?><div class="circle1  show_block changePassword_block">修改账号密码</div><div class="circle4 show_block friendShip2_notice_block" id="logout2">退出系统</div><?php endif; ?>
    </div>
  </div>
  <div class="longbox">
