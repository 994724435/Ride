...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_now">留言管理</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
  		<div class="table_title">
  			<tr id="nav">
	  			<td class="tab1"><b>姓名</b></td>
	  			<td class="tab1"><b>类型</b></td>
	  			<td class="tab1"><b>主题</b></td>
 		...
 		<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr>
	  			<td class="tab1"><?php echo ($val["ad_name"]); ?></td>
	  			<td class="tab1"><b><?php echo ($val["ad_tousu"]); ?></b></td>
	  			<td class="tab1"><b><?php echo ($val["ad_theme"]); ?></b></td>
	  			<td class="tab2"><?php echo ($val["ad_content"]); ?></td>
	  			<td class="tab3"><?php echo ($val["ad_tel"]); ?></td>
	  			<td class="tab4"><?php echo ($val["ad_time"]); ?></td>
	  			<td class="tab3"> <a class="see">查看</a><a class="close" style="display:none">关闭</a></td>
	  		<!--<td class="tab3"><a href="<?php echo U('/index.php/Admin/Message/delete',array('id'=>$val['ad_id']));?>" class="delete">删除</a> / <a class="see">查看</a><a class="close" style="display:none">关闭</a></td>-->
