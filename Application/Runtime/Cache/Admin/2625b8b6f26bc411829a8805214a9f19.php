...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_now">视频管理</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
  		<div class="table_title">
  			<tr id="nav" style="text-align: center;">
  				<td class="tab3">序号</td>
	  			<td class="tab1"><b>标题</b></td>
	  			<td class="tab2"><b>内容</td>
	  			<td class="tab4"><b>发布者</b></td>
	  			<td class="tab3"><b>操作</b></td>
  			</tr>
  		</div>
 		<div class="clear"></div>
 		<?php if(is_array($data)): foreach($data as $key=>$val): ?><form action="" method="post">
	  		<tr style="text-align: center;">
	  			<td class="tab3"><?php echo ($val["v_id"]); ?></td>
	  			<td class="tab1" >
	  				<textarea name="name" rows="3" cols="20"><?php echo ($val["v_name"]); ?></textarea>
	  			</td>
	  			<td class="tab2">
	  			 <textarea name="content" rows="8" cols="40"><?php echo ($val["v_content"]); ?></textarea>	
	  			</td>
	  			<td class="tab4">
	  			 <input type="text" id="" name="admin" value="<?php echo ($val["v_admin"]); ?>" />	
	  				</td>
	  			<td class="tab3">
	  				<input type="hidden" name="id" id="id" value="<?php echo ($val["v_id"]); ?>" />
	  				<a class="see"><input type="submit" id="" name="" value="修改"/></a>
	  				</td>
	  		</tr>
