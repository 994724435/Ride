  	...
  	<div class="menberlist">
		...
		<div class="menber_con">
			...
			<div class="menber_title">
  			...
  			<div class="clear"></div>
  			<?php if(is_array($res)): foreach($res as $key=>$val): ?><div class="photo_row" style="text-align: center;padding-top: 8px;">
  				
	  			<div class="photo_col5 f menber_col"><?php echo ($val["tg_unit"]); ?>
	  			</div>
	  			<div class="photo_col3 f menber_col"><?php echo ($val["tg_name"]); ?>
	  			</div>
	  			<div class="photo_col4 f menber_col"><?php echo ($val["tg_theme"]); ?>
	  			</div>
	  			<div class="photo_col2 f menber_col"><?php echo ($val["tg_content"]); ?>
	  			</div>
	  			<div class="photo_col6 f menber_col">
  					<a href="">审核通过</a>
  					<a href="<?php echo U('/index.php/Admin/Link/words_del',array('img_id'=>$val['tg_id']));?>">删除</a>
	  			</div>  				
  			</div>
