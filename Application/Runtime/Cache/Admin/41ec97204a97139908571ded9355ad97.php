...
<div class="rightfix">
  	<a class="home1"></a><a class="home_now">稿件管理</a>
  	<div class="clear"></div>
  	<div class="menberlist">
		...
		<div class="menber_con">
			...
			<div class="menber_title">
  			...
  			<div class="clear"></div>
  			<?php if(is_array($res)): foreach($res as $key=>$val): ?><div class="photo_row" style="text-align: center;">
  				<!--<div class="photo_td5 f"><input type="checkbox" name="idarr[]" id="" value="<?php echo ($val["tg_unit"]); ?>"></div>-->
  				<!--<div class="photo_col5 f"><input type="text" value="<?php echo ($val["tg_unit"]); ?>" imgid="<?php echo ($val["img_id"]); ?>"></div>
  				<div class="photo_col3 f"><input type="text" value="<?php echo ($val["tg_name"]); ?>" imgid="<?php echo ($val["img_id"]); ?>"></div>
  				<div class="photo_col4 f"><input type="text" value="<?php echo ($val["tg_theme"]); ?>" imgid="<?php echo ($val["img_id"]); ?>"></div>
  				<div class="photo_col2 f"><input type="text" value="<?php echo ($val["tg_content"]); ?>" imgid="<?php echo ($val["img_id"]); ?>"></div>
  				<div class="photo_col6 f">
  					<a href="<?php echo U('/index.php/Admin/Link/img_edit',array('img_id'=>$val['img_id']));?>">通过</a>
  					<a href="<?php echo U('/index.php/Admin/Link/img_del',array('img_id'=>$val['img_id']));?>">删除</a>
  				</div>-->

	  			<div class="photo_col5 f menber_col">
	  				<?php echo ($val["tg_unit"]); ?>
	  			</div>
	  			<div class="photo_col3 f menber_col">
	  				<?php echo ($val["tg_name"]); ?>
	  			</div>
	  			<div class="photo_col4 f menber_col">
	  				<?php echo ($val["tg_theme"]); ?>
	  			</div>
	  			<div class="photo_col2 f menber_col">
	  				<?php echo ($val["tg_content"]); ?>
	  			</div>
	  			<div class="photo_col6 f menber_col">
  					<a href="<?php echo U('/index.php/Admin/Link/img_edit',array('img_id'=>$val['tg_id']));?>">通过</a>
  					<a href="<?php echo U('/index.php/Admin/Link/img_del',array('img_id'=>$val['tg_id']));?>">删除</a>
	  			</div>  				
  			</div>
