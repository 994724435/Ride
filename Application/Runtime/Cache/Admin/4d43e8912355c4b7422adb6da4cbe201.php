...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">文章管理</a><a href="<?php echo U('/index.php/Admin/Article/index');?>" class="home_pass">图片管理</a><a class="home_now">图片上传</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">标题</div><div class="col_right f"><?php echo ($res['art_title']); ?></div><div class="clear"></div></div> <div class="clear"></div>
