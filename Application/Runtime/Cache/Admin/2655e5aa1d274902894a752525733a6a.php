...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_now">领导留言</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
 		...
 		<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr>
	  			...
	  			<td class="tab3"><a href="<?php echo U('/index.php/Admin/Message/Lead_mailbox_delete',array('id'=>$val['ad_id']));?>" class="delete">删除</a> <a class="close" style="display:none">关闭</a></td>
	  		</tr>
	  		<tr>
