    ...
    <div class="article_list" style="width:980px;">
        ...
        <div class="title">
          ...
          <div id="dd" class="wrapper-dropdown-3" tabindex="1">
            ...
            <ul class="dropdown"> 
              <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Article/index');?>'">未分类</a></li> 
              <?php if(is_array($acate)): foreach($acate as $key=>$value): ?><li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Article/index',array('cid'=>$value['cate_id']));?>'"><?php echo ($value["cate_name"]); ?></a></li><?php endforeach; endif; ?> 
            </ul> 
          </div> 
          <div id="aa" class="wrapper-dropdown-3" tabindex="1"> 
            ...
            <?php if($cid != 0): ?><ul class="dropdown">  
                <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Article/index',array('cid'=>$cate['cate_id']));?>'">未分类</a></li> 
                <?php if(is_array($scate)): foreach($scate as $key=>$val): ?><li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Article/index',array('cid'=>$cate['cate_id'],'sid'=>$val['cate_id']));?>'"><?php echo ($val["cate_name"]); ?></a></li><?php endforeach; endif; ?> 
              </ul> 
            <?php else: ?> 
              <ul class="dropdown"> 
                <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Article/index',array('cid'=>$cate['cate_id']));?>'">未分类</a></li> 
          ...
          <form class="allen" action="<?php echo U('/index.php/Admin/Article/index');?>"> 
