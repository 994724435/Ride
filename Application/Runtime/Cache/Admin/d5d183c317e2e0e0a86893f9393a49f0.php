...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_pass"></a><a class="home_now">纪委留言</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
 		...
 		<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr>
	  			...
	  			<td class="tab3"><a class="see">查看</a> <a class="close" style="display:none">关闭</a></td>
	  		     <!--<td class="tab3"><a href="<?php echo U('/index.php/Admin/Message/jiwei_delete',array('id'=>$val['ad_id']));?>" class="delete">删除</a> <a class="close" style="display:none">关闭</a></td>-->
